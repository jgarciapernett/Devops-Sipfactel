...
@Component({
  selector: 'app-editar-adquirientes',
  templateUrl: './editar-adquirientes.component.html',
  styleUrls: ['./editar-adquirientes.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class EditarAdquirientesComponent implements OnInit {
  public dniAdquiriente: number;
  ...
  ngOnInit() {
  this.dniAdquiriente = this.activedRoute.snapshot.params.dniAdquiriente;
    this.createForm();
  ...
  guardar(reenvio: boolean): void{
     ...
     this.service.editarAdquirientes(data, 0, "").subscribe((resp: any) => {
